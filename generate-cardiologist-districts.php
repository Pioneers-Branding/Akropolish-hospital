<?php
/**
 * Cardiologist District Pages Generator
 * Creates all 23 Haryana district pages for /cardiologist/haryana/[district]/
 */
...
$baseDir = __DIR__;
$cardiologistDir = $baseDir . '/cardiologist';
$haryanaDir = $cardiologistDir . '/haryana';

if (!is_dir($cardiologistDir)) mkdir($cardiologistDir, 0755, true);
...
foreach ($districts as $slug => $data) {
    ...
    $targetKeyword = "Best Cardiologist in $display";
    $metaTitle = "$targetKeyword | Akropolis Hospital";
    $metaDesc = "Find the best cardiologist in $display at Akropolis Super Speciality Hospital. Expert heart specialists, advanced diagnostics, and 24/7 cardiac care near " . implode(', ', $data['landmarks']) . ". NABH accredited.";
    $l0 = $data['landmarks'][0];
    $l1 = $data['landmarks'][1];
    $l2 = $data['landmarks'][2];
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="text-center lg:text-left">
          <div class="inline-flex items-center space-x-2 bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <span>Top Cardiologist Near $l0</span>
          </div>
          <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">$targetKeyword</h1>
          <p class="text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed">Board-certified cardiologists and heart specialists near $l0, $l1, and $l2. Expert cardiac care for all of $display.</p>
  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-8">Expert Cardiologist in $display</h2>
        <p class="text-lg text-gray-600 mb-6">Looking for the <strong>$targetKeyword</strong>? Akropolis Super Speciality Hospital has a team of highly experienced cardiologists providing comprehensive cardiac care for patients across $display. Whether you need a routine heart checkup near <strong>$l0</strong> or specialized cardiac treatment near <strong>$l1</strong>, our expert cardiologists are here to help.</p>
        <p class="text-lg text-gray-600 mb-6">Our cardiology department is equipped with state-of-the-art diagnostic facilities including digital Cath Lab, ECG, 2D Echocardiography, Stress Test, and Holter monitoring. We offer treatments for all heart conditions, making us the preferred choice for residents of $display and surrounding areas like $l2.</p>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-1" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">Our hospital is conveniently located and easily accessible from $l0, $l1, and all parts of $display. We offer free parking and ambulance services for emergency cases.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-3" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">We offer comprehensive heart checkup packages for early detection and prevention. Contact us to book your cardiac evaluation at our hospital near $display.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-4" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">You can book an appointment by calling $phone, using our online form, or walking in. Our cardiology team is available for consultations in $display area.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
...
PHP;
    ...
    foreach ($districts as $dSlug => $dData) {
        if ($dSlug !== $slug) {
            $page .= "          <div class=\"group\"><a href=\"/cardiologist/haryana/$dSlug/\" class=\"flex items-center space-x-3 text-gray-600 hover:text-red-500\"><div class=\"h-1.5 w-1.5 bg-gray-300 rounded-full group-hover:bg-red-500\"></div><span class=\"font-medium\">Best Cardiologist in {$dData['display']}</span></a></div>\n";
        }
    }
  ...
  <section class="py-20 bg-gradient-to-r from-red-500 to-red-600 text-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-4xl lg:text-5xl font-bold mb-6">Looking for a Cardiologist Near $l0?</h2>
        <p class="text-xl text-red-100 mb-12">Book an appointment with our expert cardiologists today. Serving $display and all of Haryana.</p>
  ...
  {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://akropolishospital.com/"}, {"@type": "ListItem", "position": 2, "name": "Cardiology", "item": "https://akropolishospital.com/cardiology.php"}, {"@type": "ListItem", "position": 3, "name": "Haryana"}, {"@type": "ListItem", "position": 4, "name": "$display"}]}
  </script>
</main>
...
PHP;
    ...
    echo "Created: cardiologist/haryana/$slug/index.php\n";
}

echo "\nAll " . count($districts) . " cardiologist district pages created!\n";