...
$page_title = 'Best Cardiologist in Panchkula | Akropolis Hospital';
$page_description = 'Find the best cardiologist in Panchkula at Akropolis Super Speciality Hospital. Expert heart specialists, advanced diagnostics, and 24/7 cardiac care near Sector 21, Panchkula, Morni. NABH accredited.';
...
<main>
    ...
    <div class="container mx-auto px-4">
      <nav class="flex text-sm text-gray-500">
        <ol class="flex items-center space-x-2">
          ...
          <li><?php echo getIcon('ChevronRight', 'h-4 w-4'); ?></li>
          <li class="text-[#328CCB] font-medium">Panchkula</li>
        </ol>
      </nav>
    </div>
  </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="text-center lg:text-left">
          <div class="inline-flex items-center space-x-2 bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <span>Top Cardiologist Near Sector 21</span>
          </div>
          <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">Best Cardiologist in Panchkula</h1>
          <p class="text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed">Board-certified cardiologists and heart specialists near Sector 21, Panchkula, and Morni. Expert cardiac care for all of Panchkula.</p>
        ...
        <div class="relative">
          <div class="relative overflow-hidden rounded-3xl shadow-2xl">
            <img width="800" height="600" src="https://brandingpioneers.co.in/akropolis/Cardiology.jpg" alt="Best Cardiologist in Panchkula" class="w-full h-[400px] lg:h-[450px] object-cover" />
          </div>
  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-8">Expert Cardiologist in Panchkula</h2>
        <p class="text-lg text-gray-600 mb-6">Looking for the <strong>Best Cardiologist in Panchkula</strong>? Akropolis Super Speciality Hospital has a team of highly experienced cardiologists providing comprehensive cardiac care for patients across Panchkula. Whether you need a routine heart checkup near <strong>Sector 21</strong> or specialized cardiac treatment near <strong>Panchkula</strong>, our expert cardiologists are here to help.</p>
        <p class="text-lg text-gray-600 mb-6">Our cardiology department is equipped with state-of-the-art diagnostic facilities including digital Cath Lab, ECG, 2D Echocardiography, Stress Test, and Holter monitoring. We offer treatments for all heart conditions, making us the preferred choice for residents of Panchkula and surrounding areas like Morni.</p>
        <div class="grid md:grid-cols-2 gap-8 mt-12">
          <div class="bg-red-50 p-8 rounded-2xl border border-red-100">
            <h3 class="text-xl font-bold text-gray-900 mb-4 flex items-center space-x-2"><?php echo getIcon('MapPin', 'h-5 w-5 text-red-500'); ?><span>Serving Near Panchkula</span></h3>
            <ul class="space-y-3">
              <li class="flex items-center space-x-3"><?php echo getIcon('MapPin', 'h-4 w-4 text-red-500'); ?><span class="text-gray-700">Sector 21</span></li>
              <li class="flex items-center space-x-3"><?php echo getIcon('MapPin', 'h-4 w-4 text-red-500'); ?><span class="text-gray-700">Panchkula</span></li>
              <li class="flex items-center space-x-3"><?php echo getIcon('MapPin', 'h-4 w-4 text-red-500'); ?><span class="text-gray-700">Morni</span></li>
            </ul>
          </div>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-3" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">We offer comprehensive heart checkup packages for early detection and prevention. Contact us to book your cardiac evaluation at our hospital near Panchkula.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-4" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">You can book an appointment by calling 9466044444, using our online form, or walking in. Our cardiology team is available for consultations in Panchkula area.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-5" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">Yes, we accept all major insurance providers and have TPA partnerships. Patients from Panchkula can avail cashless treatment at our hospital.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-20 bg-gradient-to-r from-red-500 to-red-600 text-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-4xl lg:text-5xl font-bold mb-6">Looking for a Cardiologist Near Sector 21?</h2>
        <p class="text-xl text-red-100 mb-12">Book an appointment with our expert cardiologists today. Serving Panchkula and all of Haryana.</p>
  ...
  {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://akropolishospital.com/"}, {"@type": "ListItem", "position": 2, "name": "Cardiology", "item": "https://akropolishospital.com/cardiology.php"}, {"@type": "ListItem", "position": 3, "name": "Haryana"}, {"@type": "ListItem", "position": 4, "name": "Panchkula"}]}
  </script>
</main>
