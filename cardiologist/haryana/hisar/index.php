...
<main>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="text-center lg:text-left">
          <div class="inline-flex items-center space-x-2 bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <span>Top Cardiologist Near Hisar City</span>
          </div>
          <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">Best Cardiologist in Hisar</h1>
          <p class="text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed">Board-certified cardiologists and heart specialists near Hisar City, Agricultural University, and Camp. Expert cardiac care for all of Hisar.</p>
        ...
        <div class="relative">
          <div class="relative overflow-hidden rounded-3xl shadow-2xl">
            <img width="800" height="600" src="https://brandingpioneers.co.in/akropolis/Cardiology.jpg" alt="Best Cardiologist in Hisar" class="w-full h-[400px] lg:h-[450px] object-cover" />
          </div>
  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-8">Expert Cardiologist in Hisar</h2>
        <p class="text-lg text-gray-600 mb-6">Looking for the <strong>Best Cardiologist in Hisar</strong>? Akropolis Super Speciality Hospital has a team of highly experienced cardiologists providing comprehensive cardiac care for patients across Hisar. Whether you need a routine heart checkup near <strong>Hisar City</strong> or specialized cardiac treatment near <strong>Agricultural University</strong>, our expert cardiologists are here to help.</p>
        <p class="text-lg text-gray-600 mb-6">Our cardiology department is equipped with state-of-the-art diagnostic facilities including digital Cath Lab, ECG, 2D Echocardiography, Stress Test, and Holter monitoring. We offer treatments for all heart conditions, making us the preferred choice for residents of Hisar and surrounding areas like Camp.</p>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            <button onclick="toggleFaq(0)" class="w-full px-6 py-5 flex items-center justify-between hover:bg-gray-50 transition-colors"><span class="text-left font-semibold text-gray-900">Who is the best cardiologist in Hisar?</span><svg class="h-5 w-5 text-red-500 transition-transform duration-200 faq-icon-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
            <div id="faq-answer-0" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">Akropolis Super Speciality Hospital has some of the best cardiologists in Hisar, with 15+ years of combined experience in treating all heart conditions. Our team is NABH accredited and available 24/7 for emergencies.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-1" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">Our hospital is conveniently located and easily accessible from Hisar City, Agricultural University, and all parts of Hisar. We offer free parking and ambulance services for emergency cases.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-3" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">We offer comprehensive heart checkup packages for early detection and prevention. Contact us to book your cardiac evaluation at our hospital near Hisar.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            ...
            <div id="faq-answer-4" class="hidden px-6 py-4 bg-gray-50 border-t border-gray-100 text-gray-600">You can book an appointment by calling 9466044444, using our online form, or walking in. Our cardiology team is available for consultations in Hisar area.</div>
          </div>
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
  ...
  <section class="py-20 bg-gradient-to-r from-red-500 to-red-600 text-white">
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-4xl lg:text-5xl font-bold mb-6">Looking for a Cardiologist Near Hisar City?</h2>
        <p class="text-xl text-red-100 mb-12">Book an appointment with our expert cardiologists today. Serving Hisar and all of Haryana.</p>
  ...
  {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://akropolishospital.com/"}, {"@type": "ListItem", "position": 2, "name": "Cardiology", "item": "https://akropolishospital.com/cardiology.php"}, {"@type": "ListItem", "position": 3, "name": "Haryana"}, {"@type": "ListItem", "position": 4, "name": "Hisar"}]}
  </script>
</main>
