  ...
  <div class="max-w-2xl w-full">
    <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center floating-card">
      <div class="flex justify-center mb-6">
        <div class="relative">
          <div class="absolute inset-0 bg-[#1E3A8A] rounded-full blur-2xl opacity-30 animate-pulse"></div>
          <?php echo getIcon('CheckCircle', 'w-24 h-24 text-[#1E3A8A] relative'); ?>
        </div>
      </div>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
        ...
        <ul class="text-left space-y-3 text-gray-700">
          <li class="flex items-start">
            <span class="inline-block w-6 h-6 bg-[#1E3A8A] text-white rounded-full flex-shrink-0 mr-3 text-sm font-semibold flex items-center justify-center mt-0.5">1</span>
            <span>We'll review your message and assign it to the appropriate specialist</span>
          </li>
          <li class="flex items-start">
            <span class="inline-block w-6 h-6 bg-[#1E3A8A] text-white rounded-full flex-shrink-0 mr-3 text-sm font-semibold flex items-center justify-center mt-0.5">2</span>
            <span>Our team will contact you via your preferred method of communication</span>
          </li>
          <li class="flex items-start">
            <span class="inline-block w-6 h-6 bg-[#1E3A8A] text-white rounded-full flex-shrink-0 mr-3 text-sm font-semibold flex items-center justify-center mt-0.5">3</span>
      ...
      <div class="border-t border-gray-200 pt-8 mb-8">
        ...
        <a
          ...
          class="inline-flex items-center gap-2 text-[#1E3A8A] hover:text-[#1E40AF] font-semibold text-lg transition-colors"
        >
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a
          href="/"
          class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-[#1E3A8A] text-white rounded-lg hover:bg-[#1E40AF] transition-colors font-semibold shadow-lg hover:shadow-xl"
        >
        ...
        <a
          href="/contact"
          class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-white text-[#1E3A8A] border-2 border-[#1E3A8A] rounded-lg hover:bg-blue-50 transition-colors font-semibold"
        >
