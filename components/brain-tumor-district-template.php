<?php
/**
 * Brain Tumor Treatment District Page Template (Hindi & SEO Optimized - Doctor Focused)
 */

// SEO Variables
$district_display = ucWords(str_replace('-', ' ', $district_name));
$target_keyword = "$district_display में सबसे अच्छे ब्रेन ट्यूमर इलाज";
$meta_title = "$target_keyword | अक्रोपोलिस हॉस्पिटल";
$meta_description = "$district_display में ब्रेन ट्यूमर और कैंसर का सबसे अच्छा इलाज। अक्रोपोलिस हॉस्पिटल गुरुग्राम में ब्रेन ट्यूमर स्पेशलिस्ट। अपॉइंटमेंट के लिए कॉल करें।";
    ...
    <div class="container mx-auto px-4 py-4">
      <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
          ...
          <li><a href="/oncology" class="hover:text-[#1E3A8A]">ऑन्कोलॉजी</a></li>
          <li><?php echo getIcon('ChevronRight', 'h-4 w-4'); ?></li>
          <li><a href="/brain-tumor-treatment/haryana/" class="hover:text-[#1E3A8A]">Haryana</a></li>
          <li><?php echo getIcon('ChevronRight', 'h-4 w-4'); ?></li>
    ...
    <div class="grid lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-1">
        <div class="bg-white rounded-2xl shadow-lg p-8 sticky top-24 border border-gray-100">
          <div class="text-center mb-6">
            ...
            <div class="relative inline-block">
              <img
                ...
                alt="ब्रेन ट्यूमर विशेषज्ञ - अक्रोपोलिस हॉस्पिटल"
            ...
            <p class="text-purple-600 font-semibold text-lg mb-2">
              ब्रेन और स्पाइन ट्यूमर विशेषज्ञ
            </p>
          ...
          <div class="space-y-4 mb-8">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600">18+ वर्ष</p>
              </div>
            </div>
            <div class="flex items-center space-x-3">
              <div class="bg-purple-100 p-2 rounded-lg">
              ...
              <div>
                ...
                <p class="text-gray-600">6,000+ सफल</p>
              </div>
            </div>
            <div class="flex items-center space-x-3">
              <div class="bg-purple-100 p-2 rounded-lg">
              ...
              <div>
                <p class="font-semibold text-gray-900">ट्यूमर रिमूवल</p>
          ...
          <a href="tel:<?php echo CONTACT_INFO['emergency']; ?>" class="bg-[#EA580C] hover:bg-[#C2410C] text-white w-full py-4 rounded-xl font-bold flex items-center justify-center space-x-2 transition-all duration-300 shadow-md">
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100">
          ...
          <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
            <p class="font-medium text-lg text-gray-900">
                ...
                अक्रोपोलिस हॉस्पिटल में NCR के सबसे अनुभवी न्यूरो सर्जन आपकी सेवा के लिए उपलब्ध हैं।
            </p>

            <p>
                हमारे ब्रेन ट्यूमर विशेषज्ञों के पास 18+ वर्षों का अनुभव है और उन्होंने 6,000 से अधिक सफल ब्रेन और स्पाइन ट्यूमर सर्जरी की हैं।
            ...
            <ul class="grid md:grid-cols-2 gap-4 list-none pl-0">
                ...
                <li class="flex items-center space-x-2 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
                    <?php echo getIcon('Activity', 'h-5 w-5 text-purple-500'); ?>
                    <span>ग्लियोब्लास्टोमा इलाज</span>
                </li>
                <li class="flex items-center space-x-2 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
                    <?php echo getIcon('Zap', 'h-5 w-5 text-purple-500'); ?>
                    <span>मेनिन्जियोमा सर्जरी</span>
                </li>
                <li class="flex items-center space-x-2 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
                    <?php echo getIcon('CheckCircle', 'h-5 w-5 text-purple-500'); ?>
                    <span>पिट्यूटरी ट्यूमर</span>
                </li>
                <li class="flex items-center space-x-2 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
                    <?php echo getIcon('Shield', 'h-5 w-5 text-purple-500'); ?>
                    <span>स्पाइन ट्यूमर</span>
                </li>
                <li class="flex items-center space-x-2 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
                    <?php echo getIcon('Star', 'h-5 w-5 text-purple-500'); ?>
                    <span>स्कल बेस सर्जरी</span>
                </li>
            </ul>
            ...
            <div class="bg-purple-50 p-8 rounded-2xl border-2 border-dashed border-purple-200 mt-12">
                <h4 class="text-xl font-bold text-purple-700 mb-4">ब्रेन ट्यूमर के लक्षण पहचानें - समय पर इलाज जरूरी</h4>
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <strong class="text-purple-700">लगातार सिरदर्द</strong>
                        <p class="text-sm text-gray-600">सुबह ज्यादा तेज़ सिरदर्द</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <strong class="text-purple-700">दृष्टि समस्या</strong>
                        <p class="text-sm text-gray-600">धुंधली दिखना या दोहरी दृष्टि</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <strong class="text-purple-700">याददाश्त की समस्या</strong>
                        <p class="text-sm text-gray-600">भूलने की शिकायत</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                ...
                <p class="mt-4 text-purple-900 font-semibold text-center">
                    यदि आपको ये लक्षण दिखें, तुरंत जांच कराएं: <a href="tel:<?php echo CONTACT_INFO['emergency']; ?>" class="underline font-bold"><?php echo CONTACT_INFO['emergency']; ?></a>
                </p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          ...
          <div class="space-y-4">
            ...
            $faqs = [
              [
                'q' => "$district_display में सबसे अच्छे ब्रेन ट्यूमर डॉक्टर कौन हैं?",
                'a' => "अक्रोपोलिस हॉस्पिटल के न्यूरो सर्जन $district_display समेत पूरे हरियाणा में सबसे भरोसेमंद माने जाते हैं। 18+ वर्षों के अनुभव और 6,000+ सफल सर्जरी के साथ।"
              ],
              [
                'q' => "ब्रेन ट्यूमर के लक्षण क्या हैं?",
                'a' => "लगातार सिरदर्द, दृष्टि समस्या, याददाश्त की समस्या, और बोलने में दिक्कत ब्रेन ट्यूमर के लक्षण हो सकते हैं। इनमें से कुछ भी दिखे तो तुरंत जांच कराएं।"
              ],
              [
              ...
              [
                'q' => "ब्रेन ट्यूमर का इलाज कितना में होता है?",
                'a' => "इलाज की लागत ट्यूमर के प्रकार और स्टेज पर निर्भर करती है। हमारे पास सभी बजट में इलाज उपलब्ध है और EMI विकल्प भी मौजूद है।"
              ],
              [
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
            ...
            अन्य जिलों में ब्रेन ट्यूमर इलाज
          </h3>
          <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            ?>
              <a href="/brain-tumor-treatment/haryana/<?php echo $dSlug; ?>/" class="flex items-center space-x-2 text-gray-600 hover:text-purple-500 p-2 rounded-lg hover:bg-purple-50 transition-colors">
