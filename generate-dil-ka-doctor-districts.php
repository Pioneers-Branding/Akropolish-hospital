<?php
/**
 * Generate Dil Ka Doctor Haryana District Pages
 * Creates 22 Hindi-language location pages for heart care
 */

$baseDir = __DIR__;
$haryanaDir = $baseDir . '/dil-ka-doctor/haryana';
...
echo "Created: dil-ka-doctor/haryana/index.php\n";
...
<?php
/**
 * Dil Ka Doctor District Page - {$display}
 */
\$district_name = '{$slug}';
...
PHP;
    ...
    echo "Created: dil-ka-doctor/haryana/{$slug}/index.php\n";
}

echo "\nAll " . count($districts_mapping) . " district pages created for Dil Ka Doctor!\n";
echo "URL structure: /dil-ka-doctor/haryana/[district-name]/\n";